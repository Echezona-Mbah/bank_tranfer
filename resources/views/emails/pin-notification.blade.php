...
<body>
    <div class="container">
        ...
        <div class="message">
            <p>Your transfer of {{$amoucurrencynt}}{{$amount}} has been confirmed and the beneficiary is expected to be credited within 5minutes. You available balance is {{$user->balance}}</p>
