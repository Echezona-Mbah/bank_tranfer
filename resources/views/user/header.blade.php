          ...
          <div class="btn-group-page-header ml-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  ...
                  <img class="nav-profile-img mr-2" alt="" src="{{ asset('uploads/profiles/' . $user->profile_image) }}" />
                  @else
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            ...
            <div id="updateAccountNotification" class="alert alert-warning" style="display:none;">
              Please update your account Setting. <a href="{{route('updateProfile')}}">Update Now</a>
          </div>
      @endif
