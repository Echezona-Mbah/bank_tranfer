          ...
          <div class="content-wrapper pb-0">
            ...
            <div class="row">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <form action="{{ route('allCurrency.user', ['user' => $user->id]) }}" method="post">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="user_id" value="{{ $user->id }}">
                        <h4 class="card-title">Update Exchange Rate</h4>
                        <div class="form-group">
                          <label>Exchange
                            Rate:</label>
                          <input type="amount" class="form-control form-control-lg" name="currency" value="{{ $user->currency }}" placeholder="currency" aria-label="currency	" />
                        </div>
